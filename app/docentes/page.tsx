...
export default function FacultyPage() {
  return (
    <main id="contenido-principal">
      ...
      <section className="section final-cta shell"><h2>Tu evaluación real es el mejor punto de partida.</h2><div className="button-row"><Link className="button button-primary" href="/diagnostico">Comenzar diagnóstico</Link><Link className="button button-secondary" href="/acceso">Instalar el plugin</Link></div></section>
    </main>
  );
}
